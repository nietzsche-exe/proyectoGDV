...
%>
<script src="../JavaScript/nuevoViaje.js">
</script>
</head>
<body>
    ...
    <div id="Contenedor_Principal">
        ...
        <div class="Contenedor_Busqueda">
            <form name="buscar" action="../LoginController" method="post" onsubmit="return validateDates()">
                ...
                <input type="date" name="fechaEntrada" id="fechaEntrada" required="required" min="<%= LocalDate.now() %>" value="<%= LocalDate.now() %>">
                <label for="fechaSalida">Fecha de salida</label>
                <input type="date" name="fechaSalida" id="fechaSalida" required="required" min="<%= LocalDate.now() %>">
                <label for="numeroPersonas">Número de adultos (mayores de 12 años) por habitacion</label>
