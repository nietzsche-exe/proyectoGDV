		    ...
		    <header class="Encabezado">
	            ...
	            <div id="menu-container">
	                ...
	                <ul id="menu">
	                    ...
	                    <li>&nbsp;</li>
	                    <li class="Botones_Despliegue"><a href="javascript:void(0)" onclick="javascript:document.tema.opcion.value='cerrarSesion';document.tema.submit();"><img id="imgSalir" src="../Resources/salir.png"> &nbsp; &nbsp; Cerrar Sesion</a></li>
